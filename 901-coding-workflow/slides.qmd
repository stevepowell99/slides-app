---
public: true
title: "From documents to a conclusion you can defend"
subtitle: "A nine-step workflow for AI-assisted causal coding"
format:
  revealjs:
...
Somewhere in there is the answer to your evaluation question.


::: {.fragment .panel .panel-teal}
How do you get it out, and get it out in a way you can stand behind?
:::
...
Thorough, but it does not scale. Three hundred transcripts later, the patterns are still only in your head, and nobody can check them.
:::
:::
...
::: {.lead}
One workflow from raw text to a defensible conclusion, using AI as a clerk and keeping the judgement yours.
:::
...
## We code what people said, not what is true
